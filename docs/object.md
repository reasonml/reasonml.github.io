...
Most of the time in Reason, you'd use a record to group named values together. In certain niche situations, however, you might want to use a similar feature called an object; they're a bit more flexible and come with different tradeoffs.
