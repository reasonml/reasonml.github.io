...
const getBsJsVersion = "sed -nr 's/^.*Generated by BUCKLESCRIPT VERSION ([0-9]+\.[0-9]+\.[0-9]+).*$/\\1/p' " + path.join(docusaurusJsDir, 'bs.js');
...
const bsFilename = path.join(docusaurusJsDir, 'bs.js');
