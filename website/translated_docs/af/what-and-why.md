...
Make sure you talk to us in [Discord](https://discord.gg/reasonml) first, to clear any misunderstanding/misconception! But if you *still* don't like Reason, here are some alternatives:
...
*Reason is a open source community project from Facebook*.